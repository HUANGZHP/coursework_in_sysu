...
本目录已补充一份可运行的文本词频统计程序和实验报告素材，用于完成“实验基础工具使用”练习：

- `code/text_stats.py`：仅使用 Python 标准库，统计中英文文本词频；
- `code/sample.txt`：可复现实验输入；
- `result/`：运行输出和报告插图；
- `main.tex`：按本模板编写的实验报告源文件；
- `main.pdf`：编译后的实验报告。
...
本次作业的 GitHub 仓库为 <https://github.com/HUANGZHP/coursework_in_sysu>；仓库和截图中不得出现 API Key、密码或访问令牌。
